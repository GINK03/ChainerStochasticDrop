...
#from chainer.datasets import get_cifar10
from datamanager import get_cifar10
from datamanager import get_cifar100

import models.VGG
from ResDrop50 import ResNet
from GN import GoogLeNet
import numpy as np
...
def main():
    ...
    ## dummy dataset 
    train = [(np.zeros((3, 224, 224), dtype=np.float32) , np.array(1, dtype=np.int32) ) for _ in range(20)]
    ## sys.exit()
